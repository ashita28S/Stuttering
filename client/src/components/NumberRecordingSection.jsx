...
const NumberRecordingSection = () => {
    ...
    return (
        <Box sx={{ mt: 2, p: 2, backgroundColor: '#f0f0f0', borderRadius: '8px', textAlign: 'center' }}>
            <Typography variant="h6" sx={{ mt: 1, mb: 1 }}>Please speak and record from 0 to 20 in English</Typography>
...
export default NumberRecordingSection;
