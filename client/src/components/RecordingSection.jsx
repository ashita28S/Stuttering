...
const RecordingSection = ({ passage }) => {
    ...
    return (
        <Box sx={{ mt: 2, p: 2, backgroundColor: '#f0f0f0', borderRadius: '8px' }}>
            <Typography variant="h6" sx={{ mb: 1 }}>Please read the following passage:</Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>{passage}</Typography>
