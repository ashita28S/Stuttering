                        ...
                        <Box style={{ 'paddingBottom': '10px' }}
                            ...
                            <Box>
                                <List>
                                    ...
                                    <ListItem style={{ display: "block", marginTop: "20px" }}>
                                        <Typography className='listItem' fontWeight="bold">Prof. Pradip Kumar Das</Typography>
                                        <Box style={{ marginLeft: "20px" }}>
                                            <Typography>Faculty</Typography>
                                            {/* <Typography>Electronics and Communication Engineering,</Typography> */}
                                            <Typography>Indian Institute of Technology Guwahati</Typography>
                                            <Link href='mailto:pkdas@iitg.ac.in'>pkdas@iitg.ac.in</Link>
                                        </Box></ListItem>
                                        <ListItem style={{ display: "block", marginTop: "20px" }}>
                                        <Typography className='listItem' fontWeight="bold">Ms. Ashita Batra</Typography>
                                        <Box style={{ marginLeft: "20px" }}>
                                            <Typography>Research Scholar</Typography>
                                            {/* <Typography>Electronics and Communication Engineering,</Typography> */}
                                            <Typography>Indian Institute of Technology Guwahati</Typography>
                                            <Link href='mailto:b.ashita@iitg.ac.in'>b.ashita@iitg.ac.in</Link>
                                        </Box></ListItem>
                                </List>
                                <hr />
                            </Box>
